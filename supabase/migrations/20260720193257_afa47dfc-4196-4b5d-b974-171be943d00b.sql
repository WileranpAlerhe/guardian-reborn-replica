...
('ar-britania-baq2200b','Ar-Condicionado Split Britânia BAQ2200B','Split parede, silencioso, controle remoto.','/assets/product-ac-britania.png','casa',249.9,159.9,2340,4.9,'https://shopee.com.br',ARRAY['destaque','oferta'],'Cupom de 10% já aplicado',true,0),
('fone-i12','Fone Bluetooth i12 Sem Fio',NULL,'','eletronicos',89.9,49.9,10200,4.8,'https://shopee.com.br',ARRAY['mais-vendido','oferta'],'Cupom de 10% já aplicado',true,1),
('smartwatch-d20','Smartwatch D20 Y68',NULL,'','eletronicos',149.9,89.9,8700,4.7,'https://shopee.com.br',ARRAY['mais-vendido','oferta'],'Cupom de 10% já aplicado',true,2),
('caixa-som-bluetooth','Caixa de Som Bluetooth Portátil',NULL,'','eletronicos',199.9,139.9,6300,4.6,'https://shopee.com.br',ARRAY['oferta'],'Cupom de 10% já aplicado',true,3),
('mini-liquidificador','Mini Liquidificador Portátil USB',NULL,'','casa',79.9,59.9,7100,4.7,'https://shopee.com.br',ARRAY['mais-vendido','oferta'],'Cupom de 10% já aplicado',true,4),
('tenis-casual','Tênis Casual Unissex Branco',NULL,'','moda',189.9,129.9,6400,4.8,'https://shopee.com.br',ARRAY['novo'],'Cupom de 10% já aplicado',true,5),
('perfume-importado','Perfume Feminino 100ml',NULL,'','beleza',219.9,149.9,3200,4.9,'https://shopee.com.br',ARRAY['novo','oferta'],'Cupom de 10% já aplicado',true,6);
...
('mais-vendidos','Mais Vendidos da Semana','Os favoritos dos clientes',0),
('novidades','Novidades','Chegou pra ficar',1),
('ofertas-relampago','Ofertas Relâmpago','Descontos limitados',2);
